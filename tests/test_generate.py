...
file_path1 = os.path.join(current_dir, 'fixtures/filepath1.yml')
file_path2 = os.path.join(current_dir, 'fixtures/filepath2.yml')
file_path3 = os.path.join(current_dir, 'fixtures/filepath3.yml')
file_path4 = os.path.join(current_dir, 'fixtures/filepath4.yml')
